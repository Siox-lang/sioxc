...
**Know what an agreement is worth.** Few corpus files print anything, so 140 of
the current 159 agreements compare only boilerplate on stdout. That metric is
kept visible, but it is no longer the only observable: all 159 agreements also
