...
**Know what an agreement is worth.** Few corpus files print anything, so 117 of
the current 131 agreements compare only boilerplate on stdout. That metric is
kept visible, but it is no longer the only observable: all 131 agreements also
