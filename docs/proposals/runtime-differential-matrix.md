...
**Know what an agreement is worth.** Few corpus files print anything, so 136 of
the current 155 agreements compare only boilerplate on stdout. That metric is
kept visible, but it is no longer the only observable: all 155 agreements also
